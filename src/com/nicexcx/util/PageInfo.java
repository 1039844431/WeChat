...
public class PageInfo {
   ...
   // protected  static final Logger log = Logger.getLogger("testLogger");
     ...
     */
    public PageInfo(HttpServletRequest req,int onePageCountSize) {
       ...
       this.pageSize = req.getParameter("pagesize")!=null && !req.getParameter("pagesize").equals("")?new Integer(req.getParameter("pagesize")).intValue():onePageCountSize;
       if(this.pageSize<=0){
    	   
    	   this.pageSize = onePageCountSize;
