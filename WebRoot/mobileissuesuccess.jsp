...
<script src="${pageContext.request.contextPath }/js/issue/mobile/mobile_issue.js"></script>
...
<div class="body_container">
	...
	<div class="input_out_container">
		...
		<div class="input_container">
			 ...
			 <div style="height: 300px;line-height: 100px;text-align: center;font-size: 12px;color: #FF9900">发布成功，请小主耐心等待审核，正在跳转至首页...</div>
		 </div>	
