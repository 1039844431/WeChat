...
dsy.add("0",["北京市","天津市","上海市","重庆市","河北省","山西省","内蒙古","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西","海南省","四川省","贵州省","云南省","西藏","陕西省","甘肃省","青海省","宁夏","新疆","香港","澳门","台湾省"]);
	...
	$(".select_title_work_city").on("click",function(e){
	$(".xiala").css("margin-top",$(".select_adress").offset().top -55);
	$(".select_title_work_city").addClass("select_work_city_width");
	$(".work_city_line").css("display","block");
	$(".work_city_revise").css("display","block");
	$(".xiala>div").remove();
	//省目录加载
	...
	//ss 省级名称
	var odldress = "";
	if($(".select_title_work_city>span").text() != "(必填)可多选"){
		odldress = $(".select_title_work_city>span").text() + ",";
	}
	ss=$(this).children("span").html();
	$(".info_company_work_adress").removeClass("darkness_font");
	$(".select_title_work_city>span").html(odldress + ss);
	$("#province").val(ss);
	$("#city").val("");	
	$("#county").val("");	
	x=$(this).attr("class");
	...
	$(this).children("p").append("<div class='"+x+"_"+j+"'><span>"+dsy.Items[x][j]+"</span><p></p></div>");//加载二级目录
		...
		ee.stopPropagation();
			...
			$(".select_title_work_city>span").html(si);
			$("#city").val(si);
			$(".xiala>div>p>div>p").css("display","none");
			...
			$(".select_title_work_city>span").html(odldress + xhr);
			$("#city").val(si);
			$(".xiala").css("display","none");
			$(".xiala>div>p").css("display","none");
...
////////////////////////////////////////////////////////////////////////////////	
	...
	$(".select_interview_city").on("click",function(e){
	$(".xiala").css("margin-top",$(".interview_city_title").offset().top - 50);
	$(".select_interview_city").addClass("select_work_city_width");
	...
	$(".select_interview_city>span").html(ss);
	$("#province").val(ss);
	$("#city").val("");	
	$("#county").val("");	
	x=$(this).attr("class");
	...
	$(this).children("p").append("<div class='"+x+"_"+j+"'><span>"+dsy.Items[x][j]+"</span><p></p></div>");//加载二级目录
		...
		ee.stopPropagation();
			if(($(this).children("p").css("display"))=="none"){
			si=$(this).children("span").html();
			$(".select_interview_city>span").html(si);
			$("#city").val(si);
			$(".xiala>div>p>div>p").css("display","none");
			$(this).children("p").css("display","block");
			var y=$(this).attr("class");		
			...
			$(".select_interview_city>span").html(xhr);
			$("#city").val(si);
			$(".xiala").css("display","none");
			$(".xiala>div>p").css("display","none");
...
////////////////////////////////////////////////////////////////////////////////////宣讲会
	...
	$(".preach_info_interview_work_adress").on("click",function(e){
		
	$(".xiala").css("margin-top",$(".preach_select_interview_city").offset().top - 50);
	$(".preach_select_interview_city").addClass("select_work_city_width");
	...
	//ss 省级名称
	ss=$(this).children("span").html();	
	$(".preach_select_interview_city>span").html(ss);
	$("#province").val(ss);
	$("#city").val("");	
	$("#county").val("");	
	x=$(this).attr("class");
	...
	$(this).children("p").append("<div class='"+x+"_"+j+"'><span>"+dsy.Items[x][j]+"</span><p></p></div>");//加载二级目录
		...
		ee.stopPropagation();
			...
			$(".preach_select_interview_city>span").html(xhr);
			$("#city").val(si);
			$(".xiala").css("display","none");
			$(".xiala>div>p").css("display","none");
...
$(".part_time_adress").on("click",function(e){

$(".xiala").css("margin-top",$(".part_time_adress").offset().top - 50);
$(".part_time_adress").addClass("select_work_city_width");
...
//ss 省级名称
ss=$(this).children("span").html();	
$(".select_part_time_city>span").html(ss);
$("#province").val(ss);
$("#city").val("");	
$("#county").val("");	
x=$(this).attr("class");
...
if(($(this).children("p").css("display"))=="none"){
si=$(this).children("span").html();
$(".select_part_time_city>span").html(si);
$("#city").val(si);
$(".xiala>div>p>div>p").css("display","none");
$(this).children("p").css("display","block");
var y=$(this).attr("class");		
