            ...
            $("#dateconfirm").unbind('click').click(function () {	
			  ...
			  $("#daywrapper ul li:eq("+Math.round(indexD)+")").html().substr(0,$("#daywrapper ul li:eq("+Math.round(indexD)+")").html().length-1);
               if(datetime){
                ...
                $("#datePage").hide(); 
                $("#dateshadow").hide();
                if($(".info_company_time").text() != "(必填)请选择截止时间"){
                	$(".info_company_time").removeClass("darkness_font");
                }
                if($(".preach_info_company_time").text() != "(必填)请填宣讲时间"){
                	$(".preach_info_company_time").removeClass("darkness_font");
                }
                if($(".part_time_start_time").text() != "(必填)请选择开始时间"){
                	$(".part_time_start_time").removeClass("darkness_font");
                }
                if($(".part_time_end_time").text() != "(必填)请填选择结束时间"){
                	$(".part_time_end_time").removeClass("darkness_font");
                }	
            });
