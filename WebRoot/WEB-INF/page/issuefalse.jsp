...
<div class="body_container">
	<div class="step_container">
		<div class="step_title_container">
			...
			<div class="step_title step_sort_title step_title_action">
				填写类别
			</div>
			<div class="step_title step_pic_title step_title_action">
				上传图片
			</div>
			<div class="step_title step_title_action">
				等待审核
			</div>
		</div>
		<div class="step_number_container">
			...
			<div class="step_line step_line_action"></div>
			<div class="step_line step_line2 step_line_action"></div>
			<div class="step_circle step_circle2 step_circle_action">2</div>
			<div class="step_line step_line2 step_line_action"></div>
			<div class="step_line step_line3 step_line_action"></div>
			<div class="step_circle step_circle3 step_circle_action">3</div>
			<div class="step_line step_line3 step_line_action"></div>
			<div class="step_line step_line4 step_line_action"></div>
			<div class="step_circle step_circle_action">4</div>
			<div class="step_line step_line4 step_line_action" style="width:100px;"></div>
		</div>		
	</div>
	...
	<div class="input_out_container">
		...
		<div class="input_container">
			<div class="issuesuccess">
				<div class="cry_img"></div>
				<span class="smile_message">提交失败，请小主检查文件大小和文件格式</span>
			</div>
		</div>	
