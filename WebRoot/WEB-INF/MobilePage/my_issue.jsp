...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/mobile/my_issue.js"></script>	
	
</head>
<body style="font-size: 12px;">
	<div class="list_bar">
				<a class="back" href="javascript:history.go(-1)"></a>
			  	<div class="list_bar_title">我的发布</div>
 ...
 <div class="container">
 	...
 	<div class="empty"><div class="no_favorite_word">您还没有发布哦！</div><div class="no_favorite_image"></div> </div>
